  ...
  useEffect(() => {
    ...
    if (page?._id) {
      const initialFormValues = {
        ...
        title: page.title,
        slug: page.slug,
        hero_group_image: Array.isArray(page.content?.hero_section?.group_image)
          ? page.content?.hero_section?.group_image.map((image) => ({
              url: image.url,
            }))
          : [{ url: page.content?.hero_section?.group_image }],
        ...
        success_image: Array.isArray(
            page.content?.about_section?.success_image
          )
          ...
          result_image: Array.isArray(
                page.content?.about_section?.result_image
              )
          ...
          rate_image: Array.isArray(
                    page.content?.about_section?.rate_image
                  )
      ...
      if (Array.isArray(languages)) {
        languages?.forEach((lang) => {
          initialFormValues.hero_section = initialFormValues.hero_section || {};
          initialFormValues.hero_section.title =
            initialFormValues.hero_section.title || {};
          initialFormValues.hero_section.title[lang.code] =
            page.content?.hero_section?.title?.[lang.code] || "";
      ...
      <Card>
        <Form
          ...
          onFinish={async (values) => {
            ...
            await uploadImage("hero_group_image", "hero_section");
            ...
            let formData = {
              ...
              content: {
                ...
                about_section: {
                  ...
                  rate_description:
                    values?.about_section?.rate?.description,
        ...
        >
          ...
          <div className="rounded border p-3">
            {languages?.map((l, index) => (
              ...
              >
                ...
                <FormInput
                  name={["hero_section", "title", l.code]}
          ...
          <div className="rounded border p-3">
            ...
            <MultipleImageInput
              ...
              label={i18n?.t("About Section Image")}
              required
            />
