...
export default function MedicalChat() {
    ...
    const renderChatList = () => (
        <div
            className={`w-full md:w-[40%] md:border-r overflow-hidden border-r-none ${activeChat ? "hidden lg:block" : "block"
                } bg-white shadow-lg`}
        >
            {/* Header Section */}
            ...
            <div className="overflow-y-auto hide-scrollbar h-[calc(80vh-73px)] space-y-2">
                {
                  pathname === '/user/message' &&  adminUser && (
                        <div
        ...
        <div className="flex h-[85vh] w-full bg-white">
            ...
            {activeChat ? renderChatArea() : (
                <div className="flex-1 md:flex hidden items-center justify-center flex-col text-center p-4">
                    <Image width={400} height={200} src="/images/mygif.gif" alt="Empty Inbox" className='w-[400px] h-[400] object-fill' />
                    <p className="text-lg font-medium font-poppins text-textMain mt-10">{i18n?.t("Click an inbox card to view the messages")}.</p>
